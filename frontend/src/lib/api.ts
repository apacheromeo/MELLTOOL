...
const API_URL = 'https://melltool-backend.fly.dev';
...
class ApiClient {
  ...
  async createCategory(data: { name: string; nameTh: string; description?: string; color?: string; icon?: string }) {
    return this.request('/inventory/categories', {
      method: 'POST',
      body: JSON.stringify(data),
    });
  ...
  async updateCategory(id: string, data: { name?: string; nameTh?: string; description?: string; color?: string; icon?: string }) {
