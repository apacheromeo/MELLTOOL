  ...
  return (
    <div>
      ...
      <div className="mb-8 flex items-center justify-between">
        <div>
          <h2 className="text-3xl font-bold text-gray-900 mb-2">Select Brand</h2>
          <p className="text-gray-600">Choose a brand to browse products</p>
        </div>
        <button
        ...
        <div className="grid grid-cols-2 md:grid-cols-3 lg:grid-cols-4 gap-6">
          {brands.map((brand) => (
            <button
              ...
              className="group bg-white rounded-2xl shadow-lg hover:shadow-2xl p-8 border-2 border-gray-200 hover:border-blue-500 transition-all active:scale-95"
            >
              {/* Brand Logo/Icon */}
              ...
              {/* Brand Name */}
              <h3 className="text-xl font-bold text-gray-900 mb-1 text-center group-hover:text-blue-600 transition-colors">
                {brand.name}
              </h3>
              {brand.nameTh && (
                <p className="text-sm text-gray-600 text-center">{brand.nameTh}</p>
              )}
            </button>
          ))}
        </div>
